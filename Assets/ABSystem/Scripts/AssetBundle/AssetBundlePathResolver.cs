...
namespace Tangzx.ABSystem
{
    ...
    public class AssetBundlePathResolver
    {
        ...
        /// </summary>
        public virtual string HashCacheSaveFile { get { return "Assets/StreamingAssets/AssetBundles/cache.txt"; } }
        /// <summary>
        ...
        public virtual string BundleCacheDir
        {
            get
            {
                if (cacheDir == null)
                {
                    //EDITOR_ANDROID 为新增宏，用来在编辑器测试加载缓存里的ab使用
#if UNITY_EDITOR && !EDITOR_ANDROID
