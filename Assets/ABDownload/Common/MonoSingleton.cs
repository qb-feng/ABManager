...
namespace HCFeng.ABManage.ABDownLoad
{
    ...
    public class MonoSingleton<T> : MonoBehaviour where T : Component
    {
        ...
        /// 所有继承当前unity单例的父物体名字
        /// </summary>
        private static readonly string MonoSingletonPartentName = "MonoSingleton";
            ...
            get
            {
                ...
                if (_instance == null && !_destroyed)
                {
                    ...
                    if (_instance == null)
                    {
                        ...
                        var singletonRootGo = GameObject.Find(MonoSingletonPartentName);
                        if (singletonRootGo == null)
                        {
                            singletonRootGo = new GameObject(MonoSingletonPartentName);
                            DontDestroyOnLoad(singletonRootGo);
                        }
